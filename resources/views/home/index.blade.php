...
@section('title','Laravel Havalimani Transfer Sistemi')
@section('description')
    Türkiyenin en güvenilir havalimani transfer sistemi sitesi
    @endsection
@section('keywords','Şehirler, Gidiş, Geliş, Duraklar, İletişim')
<!-- Portfolio Modals-->
<!-- Modal 1-->
